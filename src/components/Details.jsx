...
const Details = () => {
    return (
        <section className='bg-[#71bdf0] overflow-x-hidden text-white font-semibold text-center -mt-1'>
            ...
            <div className=''>
                <div className='text-center text-white font-semibold' data-aos="fade-left" data-aos-duration="1000">
                    <h3 >Time for Event: </h3>
                    <p>12 Jan 2024 8:00 PM</p>
                </div>
                <div className='mt-10 mb-3 text-center text-white font-semibold' data-aos="fade-right" data-aos-duration="1500">
                    <h3>Address:</h3>
                    ...
                    <div className='flex items-center justify-center pb-6 text-white text-sm ' >
                        <a className='btn-grad flex items-center font-semibold' href='https://maps.app.goo.gl/1ubnrW58RABN3r1p9' target='_blank'>
                            <FaMapLocation className='mr-1.5 -mt-0.5' />
                            Look at Google Maps</a>
                    </div>
                </div>
            </div>
